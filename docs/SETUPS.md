...
B11a implements schema, selection/cost/export contracts and private media/review/publication integration. Native selection, import/export and author controls follow in B11b. Three real editorial recipe candidates require actual tested components and media; the development examples remain fictional.
