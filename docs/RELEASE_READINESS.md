...
This is a development build and an implementation handoff, not a public launch sign-off. No sample author, fictional application or simulated package operation counts as external participant or Omarchy evidence.

| Gate | Current evidence |
| --- | --- |
| Native implementation | Qt 6/QML window, Rust core and private service built and exercised offscreen; see BUILD_HANDOFF.md for exact commits and test receipts |
