...
| B22 | Refunds, disputes, payouts and commerce readiness | B21 | in_progress; refund/accounting authority passes 85 Rust tests; native controls and subscription lifecycle follow |
