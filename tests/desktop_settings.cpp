...
private slots:
    ...
    void atomicReplacementAndLateCreation() {
        ...
        QTRY_COMPARE(settings.themeColors().value("page").value<QColor>(), QColor("#1a1b26"));
        ...
        QTRY_COMPARE(settings.themeColors().value("page").value<QColor>(), QColor("#fafafa"));
        QCOMPARE(settings.themeColors().value("dark").toBool(), false);
        write(theme + "/colors.toml", "background = '#eeeeee'\nforeground = '#111111'\n");
        QTRY_COMPARE(settings.themeColors().value("page").value<QColor>(), QColor("#eeeeee"));
        QVERIFY(QFile::remove(theme + "/colors.toml"));
        QTRY_VERIFY(settings.themeColors().isEmpty());
    }
    ...
    void fontconfigLiveReload() {
        ...
        QTRY_COMPARE(settings.monoFont(), QString("DejaVu Serif"));
        font("DejaVu Sans Mono");
        QTRY_COMPARE(settings.monoFont(), QString("DejaVu Sans Mono"));
    }
};
