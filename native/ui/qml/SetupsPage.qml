    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Flow {Layout.fillWidth:true;spacing:8;Button {text:"Check distribution status";enabled:!page.core.loading;onClicked:page.checkStatus()} Button {objectName:"previewSetupExport";text:"Preview selection export";enabled:page.current && page.selection.valid && !page.core.loading;onClicked:exportPreview.open()} Button {visible:!!(page.selection.maker || {}).support;text:"Support the creator";onClicked:page.core.openSetupLink("support")}}
            }
        }
    }
    Dialog {
