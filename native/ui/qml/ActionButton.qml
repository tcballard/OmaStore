...
Button {
    ...
    background: Rectangle {
        ...
        Rectangle { anchors.fill: parent; anchors.margins: -3; radius: 11; color: "transparent"; visible: control.activeFocus; border.width: 2; border.color: control.theme.accent }
    }
}
