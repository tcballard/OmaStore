            ...
            Repeater {
                ...
                Frame {
                    ...
                    ColumnLayout {
                        ...
                        Label {visible:dialog.advanced || !(dialog.plan.blockers || []).length;text:"Declared privileges: "+(modelData.privileges.length?modelData.privileges.join(", "):"none recorded")+"\nServices: "+(modelData.services.length?modelData.services.join(", "):"none recorded");Layout.fillWidth:true;wrapMode:Text.Wrap;textFormat:Text.PlainText}
