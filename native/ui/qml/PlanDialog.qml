...
Dialog {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ActionButton {theme:dialog.theme;text:dialog.advanced?"Hide system tools":"System tools & diagnostics";onClicked:dialog.advanced=!dialog.advanced}
